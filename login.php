                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    if (isset($_POST['login'])){
                                        ...
                                        $cek = mysqli_query($toll, "SELECT email_operator, password_operator from data_operator where email_operator ='$email' AND password_operator='$password'");

                                        if (mysqli_num_rows($cek) > 0) {
                                                $operator = mysqli_query($toll, "SELECT * FROM data_operator where email_operator ='$email'");
                                                ...
                                                //update last login
                                                mysqli_query($toll, "UPDATE data_operator SET last_login = '$waktu_login' where id_operator = '[id_operator]'");
