					...
					<div class="collapse navbar-collapse justify-content-between">
						<div class="header-left">
							...
							<?php
                                ...
                                $menuNames = [
                                    'index.php' => 'Dashboard',
                                    'data_jurusan.php' => 'Data Jurusan',
									'tambah_jurusan.php' => 'Tambah Jurusan',
									'edit_jurusan.php' => 'Edit Jurusan',
                                    'data_mahasiswa.php' => 'Data Mahasiswa',
									'tambah_mahasiswa.php' => 'Tambah Mahasiswa',
									'edit_mahasiswa.php' => 'Edit Mahasiswa',
                                    'data_operator.php' => 'Operator Sistem',
									'tambah_operator.php' => 'Tambah Operator',
									'edit_operator.php' => 'Edit Operator'
                                ];
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
									...
									<div class="header-info">
										<span class="text-black"><strong><?= $_SESSION['nama_operator'] ?></strong></span>
		...
		<div class="deznav">
			<div class="deznav-scroll mm-active">
				<ul class="metismenu mm-show" id="menu">
					<li class="<?= ($currentPage == 'index.php') ? 'mm-active' : '' ?>"><a href="index.php" class="ai-icon mm-active" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
					</li>
					<li class="<?= ($currentPage == 'data_jurusan.php') ? 'mm-active' : '' ?>"><a href="data_jurusan.php" class="ai-icon" aria-expanded="false">
							<i class="flaticon-381-notepad"></i>
							<span class="nav-text">Data Jurusan</span>
						</a>
					</li>
					<li class="<?= ($currentPage == 'data_mahasiswa.php') ? 'mm-active' : '' ?>"><a href="data_mahasiswa.php" class="ai-icon" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Data Mahasiswa</span>
						</a>
					</li>
					<li class="<?= ($currentPage == 'data_operator.php') ? 'mm-active' : '' ?>"><a href="data_operator.php" class="ai-icon" aria-expanded="false">
				...
				<div class="copyright">
					...
					<p>Made with <span class="heart"></span> by Dyy</p>
				</div>
			</div>
		</div>
