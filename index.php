...
$jurusan = mysqli_query($toll, "SELECT * FROM data_jurusan");
$total_jurusan = mysqli_num_rows($jurusan);
$mahasiwa = mysqli_query($toll, "SELECT * FROM data_mahasiswa");
$total_mahasiswa = mysqli_num_rows($mahasiwa);
$operator = mysqli_query($toll, "SELECT * FROM data_operator");
$total_operator = mysqli_num_rows($operator);
$laki = mysqli_query($toll, "SELECT * FROM data_mahasiswa where jenis_kelamin ='Laki-Laki'");
$perempuan = mysqli_query($toll, "SELECT * FROM data_mahasiswa where jenis_kelamin ='Perempuan'");
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														...
														<span class="title text-black font-w600"><?= $total_operator ?></span>
													</div>
												</div>
												<div class="progress" style="height:5px;">
											...
											<table class="table table-bordered">
												...
												<tbody>
													...
													<tr>
														...
														<?php $jumlah = mysqli_query($toll, "SELECT id_jurusan FROM data_mahasiswa where id_jurusan = '$get[id_jurusan]'") ?>
														<td><?= mysqli_num_rows($jumlah) ?></td>
													</tr>
													<?php endforeach ?>
												</tbody>
											</table>
